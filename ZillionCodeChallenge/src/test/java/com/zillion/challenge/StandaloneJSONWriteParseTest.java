...
/**
 * Simple test to validate JSON Output
 * 
 * @author James Drohan
 *
 */
public class StandaloneJSONWriteParseTest {
	public static void main(String[] args) throws MalformedURLException, IOException {
		
		ArrayList<PatentHolder> patentHolders = new ArrayList<PatentHolder>();
        ...
        String jsonString = objMapper.writeValueAsString(patentHolders);
